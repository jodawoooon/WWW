...
<img src="img/Untitled%203.png" width="360">

- start버튼을 누르면 시간이 증가하고 속도와 이동한 거리가 표시됩니다.
- 현재 위치를 지도에 표시하고 사용자가 움직인 경로대로 선이 표시됩니다.
- pause 또는 stop버튼을 통해 기록을 일시정지하거나 산책을 끝낼 수 있습니다.
